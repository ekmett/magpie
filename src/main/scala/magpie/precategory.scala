...
object precategory { 
  ...
  trait product[m<:hom.set,n<:hom.set] extends precategory[hom.set.product[m,n]] with phantom.product[precategory[m], precategory[n]] {
...
/*
  TODO:
    override def dual : product[hom.set.dual[m],hom.set.dual[n]] 
                      = product[hom.set.dual[m],hom.set.dual[n]](_1.dual,_2.dual)
*/
  } 
  object product {
