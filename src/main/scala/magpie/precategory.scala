...
trait precategory[h <: hom.set] {
  type =>:[A>:h#inf<:h#sup, B>:h#inf<:h#sup] = hom.C[h,A,B]
  def compose[A>:h#inf<:h#sup, B>:h#inf<:h#sup, C>:h#inf<:h#sup](f : B =>: C, g: A =>: B): A =>: C
...
object precategory { 
  ...
  trait op[h <: hom.set] extends precategory[hom.set.dual[h]] { 
    def compose[A>:hom.set.dual[h]#inf<:hom.set.dual[h]#sup, B>:hom.set.dual[h]#inf<:hom.set.dual[h]#sup, C>:hom.set.dual[h]#inf<:hom.set.dual[h]#sup](
      f: B =>: C,
      g: A =>: B): A =>: C = dual.compose[C,B,A](g, f)
  }
  object op { 
